...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      'Freeconvert에서 전체 출혈(full-bleed) 페이지를 준비한 다음 프린터의 무테두리 모드를 사용하여 가장자리까지 인쇄할 수 있습니다. 무테두리 인쇄는 대부분의 프린터가 페이지 주변에 남기는 얇은 흰색 테두리를 제거합니다. 핵심은 두 가지입니다. PDF가 실제로 페이지 가장자리까지 도달해야 하고, 프린터가 선택한 용지 크기에 대해 무테두리 설정을 지원해야 합니다...',
  },
  {
    id: '1',
    ...
    excerpt:
      'Freeconvert의 PDF 편집으로 클릭 가능한 썸네일, 링크 또는 QR 코드를 추가한 다음 업데이트된 파일을 저장하고 공유하여 PDF에 비디오를 삽입할 수 있습니다. PDF의 진정한 "삽입된" 멀티미디어는 일부 뷰어에서만 작동하며 파일을 매우 크게 만들 수 있습니다. 가장 신뢰할 수 있는 방법은 PDF에 비디오 썸네일을 배치하고 호스팅된 클립에 연결하는 것입니다...',
  },
  {
    id: '3',
    ...
    author: 'David Beníček',
    excerpt:
      'Freeconvert로 비뚤어진 페이지를 정렬하고, 기울어진 스캔을 회전하고, 깔끔하게 저장하여 온라인에서 스캔한 PDF를 똑바로 정렬할 수 있습니다. 스캔한 PDF는 종이가 스캐너에 완벽하게 정렬되지 않았기 때문에 비뚤어진 상태로 나오는 경우가 많습니다. 작은 기울기라도 특히 긴 문서나 법적 파일의 경우 읽기가 더 어려워집니다...',
  },
  {
    id: '4',
    ...
    author: 'Stéphane Turquay',
    excerpt:
      '제한을 제거한 다음 Freeconvert의 PDF 편집으로 텍스트, 이미지 또는 주석을 업데이트하여 읽기 전용 PDF를 편집 가능한 파일로 변환할 수 있습니다. 읽기 전용 PDF는 정상적으로 열리지만 변경을 차단합니다. 원인은 작성자가 설정한 권한, 편집을 위한 비밀번호 요구 사항 또는 실제 텍스트가 없는 스캔된 이미지인 파일일 수 있습니다...',
  },
  {
    id: '5',
  ...
  },
  {
    ...
    author: 'David Beníček',
    excerpt:
      'Freeconvert의 PDF 편집으로 PDF 문서에 날짜를 삽입할 수 있어 오늘 날짜나 필요한 날짜를 쉽게 추가할 수 있습니다. 때때로 PDF에 날짜 필드가 없거나 서명된 양식, 송장 또는 계약서를 보내기 전에 날짜를 추가해야 합니다. PDF는 종종 고정된 것으로 인식되지만 간단한 편집기를 사용하여 날짜를 삽입할 수 있습니다...',
  },
  {
    id: '7',
    ...
    author: 'David Beníček',
    excerpt:
      'Freeconvert의 PDF 편집으로 몇 단계만에 텍스트, 강조 표시, 도형 및 배경의 PDF 색상을 편집할 수 있습니다. 많은 사람들이 PDF가 고정되어 있다고 생각하지만 내부의 색상을 변경할 수 있습니다. PDF 글꼴 색상을 조정하거나, 다른 색조로 체크 표시를 추가하거나, 페이지의 배경색을 변경해야 할 수도 있습니다...',
  },
  {
    id: '8',
